...
def connect():
    ...
    try:
        ...
        EZ.info_logger.info(f'FAILED decryption: {e}')
    ...
    try:
        ...
        EZ.info_logger.info(f'FAILED ip discovery: {e}')
        quit()
    ...
    try:
        ...
        EZ.info_logger.info(f'FAILED port discovery: {e}')
        quit()
    ...
    try:
        ...
        EZ.info_logger.info(f'FAILED connection to Database')
        quit()
